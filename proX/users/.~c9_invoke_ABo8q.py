...
class CourseTestCase(TestCase):
    ...
    def setUp(self):
        ...
        course = Course.objects.create(name ='Physic',detail = 'No',amount ='5',count ='0' ,semester ='1',year='2')
...
class UserTestCase(TestCase):
    ...
    def setUp(self):
        ...
        User.objects.create(username='user1', password=en_password, email='user1@exp.com')
        User.objects.create(
